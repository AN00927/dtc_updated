...
const vehicles = [
  {
    ...
    desc: "A pilot study on how social media restrictions disproportionately isolate LGBTQ+ youth—currently under peer review at The Social Science Journal (Taylor & Francis).",
    blob: "rgba(56,189,248,0.85)",
    arrow: "group-hover:bg-sky-400",
  },
  {
    title: "Global Teen Restriction Database",
    desc: "The world's first systematic map of age-based internet restrictions, categorized by country and platform—built entirely by teen researchers.",
    blob: "rgba(168,139,250,0.85)",
    arrow: "group-hover:bg-violet-400",
  },
  {
    title: "Formal Governance Frameworks",
    desc: "Proprietary structural models—the Twisted Pair Legitimacy Theorem and Lemma C (Ghost Authority)—to diagnose when policies operate without legitimate oversight.",
    blob: "rgba(251,191,36,0.85)",
    arrow: "group-hover:bg-amber-400",
  },
  {
    title: "UN Website Ageism Audit",
    desc: "An opportunity-mapping database identifying every structural barrier that prevents youth from accessing and participating in global governance institutions.",
    ...
    <section className="w-full min-h-screen flex items-start py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-white dark:bg-neutral-950">
      <div className="max-w-[1400px] mx-auto w-full">
        ...
        >
          ...
          <br className="hidden sm:block" /> every stage of the policy pipeline
        </motion.h2>
